...
## [0.4.0](https://github.com/ashishrp-aws/language-server-runtimes/compare/language-server-runtimes/v0.3.6...language-server-runtimes/v0.4.0) (2025-11-11)
...
* The following workspace dependencies were updated
  * dependencies
    * @aws/language-server-runtimes-types bumped from ^0.1.62 to ^0.2.0
