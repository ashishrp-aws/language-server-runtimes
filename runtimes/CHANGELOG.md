...
## [0.4.0](https://github.com/ashishrp-aws/language-server-runtimes/compare/language-server-runtimes/v0.3.20...language-server-runtimes/v0.4.0) (2026-08-14)
...
* add 'external_idp' as a sso connection type ([#679](https://github.com/ashishrp-aws/language-server-runtimes/issues/679)) ([fb0b452](https://github.com/ashishrp-aws/language-server-runtimes/commit/fb0b4529c72d568fbf0ca212235425f52e2fd825))
* add agent interface for tool creation and usage ([c420d68](https://github.com/ashishrp-aws/language-server-runtimes/commit/c420d68c563260ea933907ceeefac117f5462ac9))
...
* add cancellation token to agent spec ([#472](https://github.com/ashishrp-aws/language-server-runtimes/issues/472)) ([1e65017](https://github.com/ashishrp-aws/language-server-runtimes/commit/1e650179dc22692ffe2c5399a45731dc520506a4))
* add diagnostic checking and workspace file opening support ([#658](https://github.com/ashishrp-aws/language-server-runtimes/issues/658)) ([1013f32](https://github.com/ashishrp-aws/language-server-runtimes/commit/1013f32172c942e5598f8fddcbfe8d6f0836da9f))
...
* add endpoint override option for easier dev setup ([#633](https://github.com/ashishrp-aws/language-server-runtimes/issues/633)) ([835e7aa](https://github.com/ashishrp-aws/language-server-runtimes/commit/835e7aac5db7068c711a04b41242e73fc5edc828))
* add env variables getter in runtime ([#295](https://github.com/ashishrp-aws/language-server-runtimes/issues/295)) ([93be997](https://github.com/ashishrp-aws/language-server-runtimes/commit/93be9970f8c6aa23f609220e0c132e37fe567210))
...
* add initialization configuration options for file indexing ([#436](https://github.com/ashishrp-aws/language-server-runtimes/issues/436)) ([155546f](https://github.com/ashishrp-aws/language-server-runtimes/commit/155546fe092bad040817abd21816ec5051b897f3))
...
* add operational telemetry interface ([#312](https://github.com/ashishrp-aws/language-server-runtimes/issues/312)) ([44ae86c](https://github.com/ashishrp-aws/language-server-runtimes/commit/44ae86c1f33b2a71702cc55b2ad78c2ec22e380f))
* add opt-out mechanism to operational telemetry ([#330](https://github.com/ashishrp-aws/language-server-runtimes/issues/330)) ([0de11b1](https://github.com/ashishrp-aws/language-server-runtimes/commit/0de11b10b5556848633df351defe84350c7b5da1))
* add routing to didCreateFiles, didDeleteFiles, didRenameFiles & didSaveTextDocument ([#512](https://github.com/ashishrp-aws/language-server-runtimes/issues/512)) ([c4c2bc4](https://github.com/ashishrp-aws/language-server-runtimes/commit/c4c2bc48af9f7c432af97d318bc5f580ccf76067))
* add save option to initializeResult to allow LSP server to listen to save file events ([#309](https://github.com/ashishrp-aws/language-server-runtimes/issues/309)) ([d80688f](https://github.com/ashishrp-aws/language-server-runtimes/commit/d80688fe272cedd352a9e5ed8cd13279cad392a7))
* add supplemental context api ([#672](https://github.com/ashishrp-aws/language-server-runtimes/issues/672)) ([04e6cb4](https://github.com/ashishrp-aws/language-server-runtimes/commit/04e6cb490c0e53ed054641605177971101b95af1))
...
* add workspaceIdentifier to AWSInitializationOptions ([#497](https://github.com/ashishrp-aws/language-server-runtimes/issues/497)) ([256c549](https://github.com/ashishrp-aws/language-server-runtimes/commit/256c549df6d446886457dd83ea4b71f31d3bf063))
...
* adding support for alternate bearer token ([#715](https://github.com/ashishrp-aws/language-server-runtimes/issues/715)) ([2ae27f3](https://github.com/ashishrp-aws/language-server-runtimes/commit/2ae27f3ee6da4666fb1be6168bd14634705c3305))
* adding support for readFileSync method in workspace.fs ([#299](https://github.com/ashishrp-aws/language-server-runtimes/issues/299)) ([3ef292a](https://github.com/ashishrp-aws/language-server-runtimes/commit/3ef292a483d0f41e804511e1d951e09f5da36d46))
* allow write stream for tool invocations ([07e7c53](https://github.com/ashishrp-aws/language-server-runtimes/commit/07e7c534d715836c99c08451e07805d8bf5cd668))
* change getConfigurationFromServer to fetch from all servers and aggregate ([#489](https://github.com/ashishrp-aws/language-server-runtimes/issues/489)) ([5c13d69](https://github.com/ashishrp-aws/language-server-runtimes/commit/5c13d6968683422468982ea1a1d7ac21d1649ae2))
* collect telemetry data from standalone runtime ([#392](https://github.com/ashishrp-aws/language-server-runtimes/issues/392)) ([76d6869](https://github.com/ashishrp-aws/language-server-runtimes/commit/76d68699fdb49147427b22574d7d1794c0bc31e6))
...
* delegate lsp to handle context command filtering ([#743](https://github.com/ashishrp-aws/language-server-runtimes/issues/743)) ([8836c33](https://github.com/ashishrp-aws/language-server-runtimes/commit/8836c335180c13142b6789637cc5f3915e4a5475))
* delegate lsp to handle context command filtering ([#745](https://github.com/ashishrp-aws/language-server-runtimes/issues/745)) ([2c7174a](https://github.com/ashishrp-aws/language-server-runtimes/commit/2c7174a53ef792021c2d070867d87efe5ae2f7a8))
* delete cognito, update optel sdk, use otlp exporters ([#437](https://github.com/ashishrp-aws/language-server-runtimes/issues/437)) ([446b1b8](https://github.com/ashishrp-aws/language-server-runtimes/commit/446b1b8d47248ac4b64b7711e44b32c7c5e8cd10))
* emit telemetry event to lsp client on standalone process crash ([432a68a](https://github.com/ashishrp-aws/language-server-runtimes/commit/432a68a3f46768dfbdc8e5233ff4b825cbaa1b92))
* empty line PR to release https://github.com/aws/language-server-runtimes/pull/379 ([#382](https://github.com/ashishrp-aws/language-server-runtimes/issues/382)) ([2663a5e](https://github.com/ashishrp-aws/language-server-runtimes/commit/2663a5e748e1b63e5b422968af562fd39f9a0da2))
* enable operational telemetry ([#539](https://github.com/ashishrp-aws/language-server-runtimes/issues/539)) ([f49206f](https://github.com/ashishrp-aws/language-server-runtimes/commit/f49206f8c6e10c4a408c96359adb6165122273f6))
* expose predicate to check symbolic link ([02002af](https://github.com/ashishrp-aws/language-server-runtimes/commit/02002af823cce5feeefb00e243d8b48beab576e6))
...
* get telemetry aws config from env variables ([#345](https://github.com/ashishrp-aws/language-server-runtimes/issues/345)) ([e2d7267](https://github.com/ashishrp-aws/language-server-runtimes/commit/e2d7267aff2a5c3d3fe92131b9478319a9a91c6e))
* implement sdk runtime configurator to configure sdk clients at runtime ([#316](https://github.com/ashishrp-aws/language-server-runtimes/issues/316)) ([ef82756](https://github.com/ashishrp-aws/language-server-runtimes/commit/ef827565b32d1482b6e08d66b78774d7aed544eb))
* inject home directory into runtimes.  ([#424](https://github.com/ashishrp-aws/language-server-runtimes/issues/424)) ([595475e](https://github.com/ashishrp-aws/language-server-runtimes/commit/595475e448e9dc8fb74c4aec9c31eb7852db6e45))
* migrate from AWS SDK v2 to v3 ([#685](https://github.com/ashishrp-aws/language-server-runtimes/issues/685)) ([66a6c6d](https://github.com/ashishrp-aws/language-server-runtimes/commit/66a6c6dd45ee684965208cbb4e2df505c9063e9f))
...
* **runtimes:** add auto-discovery for OS proxy settings ([#553](https://github.com/ashishrp-aws/language-server-runtimes/issues/553)) ([d3e961a](https://github.com/ashishrp-aws/language-server-runtimes/commit/d3e961abccd0421a6937f8b60708b81cac310aa4))
...
* **runtimes:** add UpdateConfiguration protocol and server handlers ([df24447](https://github.com/ashishrp-aws/language-server-runtimes/commit/df244475bf08caafd6fb4c905de8fbbce970af1d))
* **runtimes:** cache and expose initializeParams as a feature ([#378](https://github.com/ashishrp-aws/language-server-runtimes/issues/378)) ([e3d4e17](https://github.com/ashishrp-aws/language-server-runtimes/commit/e3d4e1772d29955ae71a6761f1be3251c443215e))
* **runtimes:** emit telemetry from SDK proxy configuration utility ([a82a708](https://github.com/ashishrp-aws/language-server-runtimes/commit/a82a70810592909e1d82c74406124de847f1af0b))
* **runtimes:** extend awsClientCapabilities generically to signal server-specific capabilities ([9fd0f00](https://github.com/ashishrp-aws/language-server-runtimes/commit/9fd0f00a784521c9ae4dac360d2eb8c81ab299fa))
* **runtimes:** extend lsp with didSaveTextDocument and lsp.worksapce with didCreateFiles, didDeleteFiles and didRenameFiles ([e8df283](https://github.com/ashishrp-aws/language-server-runtimes/commit/e8df28359cdca9efdaf05dd963ef52d7fc45531b))
* **runtimes:** extend TestFeatures with API for simulating LSP init flow ([#483](https://github.com/ashishrp-aws/language-server-runtimes/issues/483)) ([fa41c3d](https://github.com/ashishrp-aws/language-server-runtimes/commit/fa41c3d662cdf5f9cd5c2312f7f11abbda50045f))
* **runtimes:** extended network proxy support ([7369086](https://github.com/ashishrp-aws/language-server-runtimes/commit/7369086ad519843f0dfc74f7124e23f129f21e63))
* **runtimes:** extract reusable runtime logic into the `base-runtime.ts` ([ebcb52f](https://github.com/ashishrp-aws/language-server-runtimes/commit/ebcb52f66dca8c85d3a842b21c8dbaccb19d6ad0))
* **runtimes:** log detail server info during initialization ([#285](https://github.com/ashishrp-aws/language-server-runtimes/issues/285)) ([cd4ac14](https://github.com/ashishrp-aws/language-server-runtimes/commit/cd4ac14381599c8599c70a6df85ac62cc9668832))
...
* support remove tool in Agent ([#501](https://github.com/ashishrp-aws/language-server-runtimes/issues/501)) ([443415e](https://github.com/ashishrp-aws/language-server-runtimes/commit/443415ee15349913eb2e8876cb56bb26c02a9e31))
* support using rootUri for workspaceFolders and handle workspaceChangeEvent ([#509](https://github.com/ashishrp-aws/language-server-runtimes/issues/509)) ([fa9892e](https://github.com/ashishrp-aws/language-server-runtimes/commit/fa9892ed7d4d4ff09f0801fdbff07bc1d725ef85))
* **types:** add a feature flag support for show logs ([#631](https://github.com/ashishrp-aws/language-server-runtimes/issues/631)) ([eec091e](https://github.com/ashishrp-aws/language-server-runtimes/commit/eec091eb7354eedae27fd623d379107f4d4e3196))
* **types:** add mode to fs writeFile ([#423](https://github.com/ashishrp-aws/language-server-runtimes/issues/423)) ([daae4e8](https://github.com/ashishrp-aws/language-server-runtimes/commit/daae4e8e665bd334e6109921d9efcd5ab12c4ff8))
...
* **types:** introduce new completion API for edits suggestion ([#635](https://github.com/ashishrp-aws/language-server-runtimes/issues/635)) ([26ecf77](https://github.com/ashishrp-aws/language-server-runtimes/commit/26ecf770be41b2fa12b9255b446a498c7c209e49))
* **types:** types for device code support ([#353](https://github.com/ashishrp-aws/language-server-runtimes/issues/353)) ([aa2fd53](https://github.com/ashishrp-aws/language-server-runtimes/commit/aa2fd53ab14bbe412ede696e7eb86cd19a9b9b0b))
...
* add aws-sdk to dependencies ([#535](https://github.com/ashishrp-aws/language-server-runtimes/issues/535)) ([d8890a6](https://github.com/ashishrp-aws/language-server-runtimes/commit/d8890a6b6add4a4485e40ad7bc2de41f32045d14))
* add document change params ([#618](https://github.com/ashishrp-aws/language-server-runtimes/issues/618)) ([76d258f](https://github.com/ashishrp-aws/language-server-runtimes/commit/76d258f833a7b3a94350a60fafe7688a1c87198c))
* add file context override for inline completion ([#660](https://github.com/ashishrp-aws/language-server-runtimes/issues/660)) ([f6f0da8](https://github.com/ashishrp-aws/language-server-runtimes/commit/f6f0da86e935c148c357852a15f43e56c2a7ba44))
* add methods to fetch builtIn and builtInWrite tools ([#581](https://github.com/ashishrp-aws/language-server-runtimes/issues/581)) ([aa914a7](https://github.com/ashishrp-aws/language-server-runtimes/commit/aa914a74821e36104635865c4f0dff2973d6ced4))
* add missing telemetry files ([#344](https://github.com/ashishrp-aws/language-server-runtimes/issues/344)) ([e592796](https://github.com/ashishrp-aws/language-server-runtimes/commit/e592796f901000e58fbdf93860a50ea697adaa89))
* add open tab params to inline completion protocol  ([#645](https://github.com/ashishrp-aws/language-server-runtimes/issues/645)) ([56c9fe0](https://github.com/ashishrp-aws/language-server-runtimes/commit/56c9fe01cca4aacfc15e3a8116a44b72ad10d43a))
* add open tab params to inline completion protocol ([#638](https://github.com/ashishrp-aws/language-server-runtimes/issues/638)) ([fcdf0ac](https://github.com/ashishrp-aws/language-server-runtimes/commit/fcdf0ac24561e32ce079a568b65f9df534e8a140))
...
* adding try/catch to initialize lsp server, added telemetry log events  ([#320](https://github.com/ashishrp-aws/language-server-runtimes/issues/320)) ([48b064b](https://github.com/ashishrp-aws/language-server-runtimes/commit/48b064b5b690e5ce49efff2066f60b58b6f283d2))
* agent tools are shared between servers ([01a9f08](https://github.com/ashishrp-aws/language-server-runtimes/commit/01a9f08f5c1f5920f519461fae8a7b8d92578233))
* align proxy detection with Node.js CLI behavior in Windows ([#562](https://github.com/ashishrp-aws/language-server-runtimes/issues/562)) ([90aa4d3](https://github.com/ashishrp-aws/language-server-runtimes/commit/90aa4d357123813caf17e94b0c1780d09eec4d5f))
* atx bearer no longers update credential metadata ([#732](https://github.com/ashishrp-aws/language-server-runtimes/issues/732)) ([8b03630](https://github.com/ashishrp-aws/language-server-runtimes/commit/8b03630cce84bf145ac4cd7dadec88698c83bba5))
* avoid deprecated attribute path ([8efb2de](https://github.com/ashishrp-aws/language-server-runtimes/commit/8efb2deff9aeb670f211920d892f0ba3c17bab0e))
* avoid duplicate url with forward slash in the end ([#592](https://github.com/ashishrp-aws/language-server-runtimes/issues/592)) ([ac2eb62](https://github.com/ashishrp-aws/language-server-runtimes/commit/ac2eb62d3d3ad50a2f8092a5649db087e784fa81))
* avoid path import ([5ee633a](https://github.com/ashishrp-aws/language-server-runtimes/commit/5ee633aedcdb5244e9b7b2aa92534ebe07aee761))
* bump node-forge to ^1.4.0 to resolve CVEs ([#746](https://github.com/ashishrp-aws/language-server-runtimes/issues/746)) ([c1cd1a4](https://github.com/ashishrp-aws/language-server-runtimes/commit/c1cd1a49775b188bd892540e11126b6dfe907dd3))
* CI builds failing due to proxyquire incompatibility with Node.js 24 ([#700](https://github.com/ashishrp-aws/language-server-runtimes/issues/700)) ([1e6bcab](https://github.com/ashishrp-aws/language-server-runtimes/commit/1e6bcabddf0634cea231fc7441511dab6c0431f7))
* correct global context configuration param type ([#439](https://github.com/ashishrp-aws/language-server-runtimes/issues/439)) ([95c40fc](https://github.com/ashishrp-aws/language-server-runtimes/commit/95c40fca6212cc7d0f0e7c33d44fb0d8322f22f7))
* cve ([#719](https://github.com/ashishrp-aws/language-server-runtimes/issues/719)) ([90597c2](https://github.com/ashishrp-aws/language-server-runtimes/commit/90597c209287640aeae34be4f5dbae35787c6e45))
* dummy commit to trigger release-please ([#750](https://github.com/ashishrp-aws/language-server-runtimes/issues/750)) ([ee03545](https://github.com/ashishrp-aws/language-server-runtimes/commit/ee03545c1e4d0a1d530fc59563de526e9d36433a))
* explicit check for initializationOptions and add optional chaining ([#310](https://github.com/ashishrp-aws/language-server-runtimes/issues/310)) ([e97456d](https://github.com/ashishrp-aws/language-server-runtimes/commit/e97456d6d5352042364f860483ea2721fc3268e1))
* export operational telemetry schemas ([#340](https://github.com/ashishrp-aws/language-server-runtimes/issues/340)) ([5b4ca25](https://github.com/ashishrp-aws/language-server-runtimes/commit/5b4ca25a03a3cfe5671bb01eae8e1d3c92c3b979))
* filter expired certificates in tets ([#506](https://github.com/ashishrp-aws/language-server-runtimes/issues/506)) ([2dbb80f](https://github.com/ashishrp-aws/language-server-runtimes/commit/2dbb80f15f9c770f104d1af9910bd71fa591b38b))
* fix the flaky test timeout error ([#359](https://github.com/ashishrp-aws/language-server-runtimes/issues/359)) ([b907843](https://github.com/ashishrp-aws/language-server-runtimes/commit/b9078435c918077215ff127ca8e84425bda9c4c0))
* handling of aws object of initializationOptions and initialize error handling ([#306](https://github.com/ashishrp-aws/language-server-runtimes/issues/306)) ([f71547a](https://github.com/ashishrp-aws/language-server-runtimes/commit/f71547a7a27adb62231e2c096560988a09ff6fea))
* improve diffs array error msg ([#639](https://github.com/ashishrp-aws/language-server-runtimes/issues/639)) ([10b0371](https://github.com/ashishrp-aws/language-server-runtimes/commit/10b037133608610e2edf2b1c4b752b09f3b74580))
* improve tool input validation logic to return specific error message ([#578](https://github.com/ashishrp-aws/language-server-runtimes/issues/578)) ([5923cf8](https://github.com/ashishrp-aws/language-server-runtimes/commit/5923cf8e711877ede03ecc761085f11b6ab66d4b))
* initialize telemetry asynchronously without blocking ([#666](https://github.com/ashishrp-aws/language-server-runtimes/issues/666)) ([28ee764](https://github.com/ashishrp-aws/language-server-runtimes/commit/28ee7640dab43b42d320753cd7837995009162ee))
* log uncaughtException errors directly to stderr ([#612](https://github.com/ashishrp-aws/language-server-runtimes/issues/612)) ([a4648ea](https://github.com/ashishrp-aws/language-server-runtimes/commit/a4648ea96eeb389d558f05b926e51c1b4e03a2b2))
* make test independent of sdk version ([#519](https://github.com/ashishrp-aws/language-server-runtimes/issues/519)) ([112feba](https://github.com/ashishrp-aws/language-server-runtimes/commit/112feba70219a98a12f13727d67c540205fa9c9f))
* more logging for SSL certificates ([#727](https://github.com/ashishrp-aws/language-server-runtimes/issues/727)) ([98aaaa3](https://github.com/ashishrp-aws/language-server-runtimes/commit/98aaaa3f28ef134eb737292a11e2cbc25184db7b))
* moving the telemetry logging for initialization options to the l… ([#337](https://github.com/ashishrp-aws/language-server-runtimes/issues/337)) ([3f0a826](https://github.com/ashishrp-aws/language-server-runtimes/commit/3f0a8262ea8e809341ffce4f503517339267917b))
* onDidSaveTextDocument routing ([#590](https://github.com/ashishrp-aws/language-server-runtimes/issues/590)) ([3660267](https://github.com/ashishrp-aws/language-server-runtimes/commit/36602670b42d4db2ff33e565819dba411b5256de))
* override undici to ^7.0.0 ([#734](https://github.com/ashishrp-aws/language-server-runtimes/issues/734)) ([69d984f](https://github.com/ashishrp-aws/language-server-runtimes/commit/69d984f4c4134927f71b86cd2bfff088542ddba5))
* put extended proxy behind feature flag ([#385](https://github.com/ashishrp-aws/language-server-runtimes/issues/385)) ([41b01bd](https://github.com/ashishrp-aws/language-server-runtimes/commit/41b01bd0131afc76c2dd52f5d3b763751352ca3e))
* refactor auto-discovery for OS proxy settings ([#595](https://github.com/ashishrp-aws/language-server-runtimes/issues/595)) ([0e68235](https://github.com/ashishrp-aws/language-server-runtimes/commit/0e682359479e8f099447adac3105658b7a0f8b50))
* refactor auto-discovery for OS proxy settings ([#654](https://github.com/ashishrp-aws/language-server-runtimes/issues/654)) ([e1b033f](https://github.com/ashishrp-aws/language-server-runtimes/commit/e1b033f9785862ca2fbb956ba6b1436176672b71))
* remove duplicate uri of workspace paths sent by VS ([#585](https://github.com/ashishrp-aws/language-server-runtimes/issues/585)) ([aed6187](https://github.com/ashishrp-aws/language-server-runtimes/commit/aed61874f7698ec5d094945da70dac5d5471112a))
* remove the supports workspace check for didChangeWorkspaceFolder event ([#522](https://github.com/ashishrp-aws/language-server-runtimes/issues/522)) ([f5977cc](https://github.com/ashishrp-aws/language-server-runtimes/commit/f5977cc52bfd5048da48ed0e67e3bebcd302f7b4))
* replace path.basename with custom browser-safe implementation ([#636](https://github.com/ashishrp-aws/language-server-runtimes/issues/636)) ([a2b8532](https://github.com/ashishrp-aws/language-server-runtimes/commit/a2b8532e5db15615f7aa0349f4cca8835716e85b))
* resolve Windows issue with system proxy detection ([#560](https://github.com/ashishrp-aws/language-server-runtimes/issues/560)) ([e59a220](https://github.com/ashishrp-aws/language-server-runtimes/commit/e59a2202c6c8f7a15b38c36c4eebeedfc56b70d3))
* revert the version of jose to 5.9.6 ([#441](https://github.com/ashishrp-aws/language-server-runtimes/issues/441)) ([6ebc326](https://github.com/ashishrp-aws/language-server-runtimes/commit/6ebc326eaf577159ba1bbaace37c24b6a0633226))
* route correct request type to button click ([#467](https://github.com/ashishrp-aws/language-server-runtimes/issues/467)) ([d481123](https://github.com/ashishrp-aws/language-server-runtimes/commit/d4811237789514df1420f0842819f9a4de83dc5f))
* **runtimes:** add doUpdateConfiguration to TestFeatures ([21d5d1d](https://github.com/ashishrp-aws/language-server-runtimes/commit/21d5d1dc7c73499475b7c88c98d2ce760e5d26c8))
* **runtimes:** add PII filtering for process crash error reporting ([4ee967d](https://github.com/ashishrp-aws/language-server-runtimes/commit/4ee967db29d26a5aa12e0d5263fb69c2773209d5))
* **runtimes:** catch unhandled encryption validation and process exeptions ([e950103](https://github.com/ashishrp-aws/language-server-runtimes/commit/e9501038192fbc6acfa144f48c33faeef61d69d8))
* **runtimes:** fix protocol/lsp circular dependency ([#573](https://github.com/ashishrp-aws/language-server-runtimes/issues/573)) ([2231db0](https://github.com/ashishrp-aws/language-server-runtimes/commit/2231db070e0429adc11cf872a7f7046ffdc8207d))
* **runtimes:** maintain nodejs built-in certificates for SDK proxy configuration ([#362](https://github.com/ashishrp-aws/language-server-runtimes/issues/362)) ([83fa698](https://github.com/ashishrp-aws/language-server-runtimes/commit/83fa698b3d0446f1b3cb6f1237866910a966026f))
* **runtimes:** replace mac-ca with native macOS certificate reading ([#736](https://github.com/ashishrp-aws/language-server-runtimes/issues/736)) ([134d721](https://github.com/ashishrp-aws/language-server-runtimes/commit/134d72158f73d2cd3614bf39fa24ad6ed9c9da0e))
* **runtimes:** replace registry-js with native reg query to remove vu… ([#737](https://github.com/ashishrp-aws/language-server-runtimes/issues/737)) ([a92164a](https://github.com/ashishrp-aws/language-server-runtimes/commit/a92164a65c105866aa6664af6420cf2443c9039c))
* **runtimes:** timeout for exiting to emit logs ([#602](https://github.com/ashishrp-aws/language-server-runtimes/issues/602)) ([0a062a3](https://github.com/ashishrp-aws/language-server-runtimes/commit/0a062a38854213ebe8ed388dc42c37ec65682473))
* skip PAC URLs in macOS proxy detection ([#664](https://github.com/ashishrp-aws/language-server-runtimes/issues/664)) ([92fb02d](https://github.com/ashishrp-aws/language-server-runtimes/commit/92fb02d1d4c6aedb7b59b042b8d10e54bb750d92))
* support JSON Schema extension keywords and properly infer required fields ([995a306](https://github.com/ashishrp-aws/language-server-runtimes/commit/995a3066a445b7466a22faeba0b4f7d35d0fb9a0))
* syntax errors on some Mac builds and flaky Darwin test ([#550](https://github.com/ashishrp-aws/language-server-runtimes/issues/550)) ([687ec5a](https://github.com/ashishrp-aws/language-server-runtimes/commit/687ec5a8d50129e29e517802cf60f101b66b8d6f))
* throw error on initialize fail ([#307](https://github.com/ashishrp-aws/language-server-runtimes/issues/307)) ([df148a2](https://github.com/ashishrp-aws/language-server-runtimes/commit/df148a27bf4d84ec3466920848eff3e70bef493a))
* update repository URLs to the Amazon-Q-Developer org ([#775](https://github.com/ashishrp-aws/language-server-runtimes/issues/775)) ([d11ff5c](https://github.com/ashishrp-aws/language-server-runtimes/commit/d11ff5cfd3f4bfb778ef72965265f9de68030c78))
* update shape of process crash telemetry event ([0ccd083](https://github.com/ashishrp-aws/language-server-runtimes/commit/0ccd0837775101668aa6d32e31b6b33cbd010c11))
* updating atxCredentialProvider accessible in server ([#718](https://github.com/ashishrp-aws/language-server-runtimes/issues/718)) ([a0b50d4](https://github.com/ashishrp-aws/language-server-runtimes/commit/a0b50d40340a41724ab5cb14371bff869e7e234e))
* use logging instead of lspConsole ([#545](https://github.com/ashishrp-aws/language-server-runtimes/issues/545)) ([bcd5ef9](https://github.com/ashishrp-aws/language-server-runtimes/commit/bcd5ef90addf15b9c83ca24b9af68919bfeb6c48))
* use Node16 moduleResolution to support modern package exports maps ([#761](https://github.com/ashishrp-aws/language-server-runtimes/issues/761)) ([576ff36](https://github.com/ashishrp-aws/language-server-runtimes/commit/576ff366b29fb06b2d468884145a45c5176527bd))
...
* pr 719 as dependency change cause unexpected network issue on windows machine  ([#729](https://github.com/ashishrp-aws/language-server-runtimes/issues/729)) ([3987770](https://github.com/ashishrp-aws/language-server-runtimes/commit/3987770c5870d049cb5eb549dbe6a45175946798))
* refactor auto-discovery for OS proxy settings ([#595](https://github.com/ashishrp-aws/language-server-runtimes/issues/595))" ([#604](https://github.com/ashishrp-aws/language-server-runtimes/issues/604)) ([2bc289e](https://github.com/ashishrp-aws/language-server-runtimes/commit/2bc289eac95b5fb01e9383754f7c73234c9616ef))
...
* The following workspace dependencies were updated
  * dependencies
    * @aws/language-server-runtimes-types bumped from ^0.1.66 to ^0.2.0
