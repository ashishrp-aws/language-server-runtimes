...
## [0.2.102](https://github.com/ashishrp-aws/language-server-runtimes/compare/language-server-runtimes/v0.2.101...language-server-runtimes/v0.2.102) (2025-06-26)
...
* The following workspace dependencies were updated
  * dependencies
    * @aws/language-server-runtimes-types bumped from ^0.1.42 to ^0.2.0
